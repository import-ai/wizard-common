...
class TaskFunction(StrEnum):
    ...
    PARSE_RSS_ITEM = "parse_rss_item"
    WEB_ANALYSIS = "web_analysis"
    UPSERT_INDEX = "upsert_index"
    DELETE_INDEX = "delete_index"
    FILE_READER_TEXT = "file_reader_text"
    FILE_READER_PPT = "file_reader_ppt"
    FILE_READER_WORD = "file_reader_word"
    FILE_READER_PDF = "file_reader_pdf"
    FILE_READER_AUDIO = "file_reader_audio"
    FILE_READER_VIDEO = "file_reader_video"
    FILE_READER_IMAGE = "file_reader_image"
